...
import motionsiteLogo from "@/assets/motionsite_logo.png";
import lovableLogo from "@/assets/lovable_logo.png";
import { FadeInUp } from "./FadeInUp";
import { TiltCard } from "./TiltCard";
import { SimpleBadge } from "./SimpleBadge";

export const MotionSites = () => {
  return (
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="items-center flex-col">
          <div className="items-center flex-col justify-start text-center flex gap-6 mb-12">
            <FadeInUp delay={0}>
              <SimpleBadge label="Lifetime access included" />
            </FadeInUp>
            <FadeInUp delay={0.1}>
              <img 
            ...
            <FadeInUp delay={0.2}>
              <h2 className="text-violet-100 text-5xl lg:text-6xl font-semibold max-w-4xl flex items-center justify-center flex-wrap gap-3">
                Your AI Design <img src={lovableLogo} alt="Lovable" className="h-12 lg:h-16 w-auto inline-block" /> System.
              </h2>
            </FadeInUp>
          </div>
          <FadeInUp delay={0.4}>
